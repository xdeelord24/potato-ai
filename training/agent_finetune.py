"""
Agent fine-tuning for Potato AI (ReAct / tool-use format).
"""
...
def main():
    ...
    parser.add_argument("--checkpoint", type=Path, help="SFT or pre-train checkpoint")
    ...
    torch.save(model.state_dict(), args.output_dir / f"agent_{args.config}.pt")
    print("Done.")
